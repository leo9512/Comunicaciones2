...
Tank= function (index, game, player, bullets) {
    ...
    var x = game.world.randomX; // donde inicia el tank
    ...
    this.tank.body.bounce.setTo(1, 1); // rebote del tank

    this.tank.angle = game.rnd.angle();

    game.physics.arcade.velocityFromRotation(this.tank.rotation, 100, this.tank.body.velocity); // diferente 
